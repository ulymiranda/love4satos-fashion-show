        ...
        <section className="card-dark mb-8">
          ...
          <div className="space-y-1">
            {[
              ...
              ['6:00 PM', 'Runway Show Continues — Audience Applause & Crowd Favorites'],
              ['6:00 – 6:30 PM', 'Runway Round 1 — Dogs Showcase Their Costumes to the Crowd'],
              ['6:30 – 7:00 PM', 'Runway Round 2 — Final Walks & Audience Interaction'],
              ['7:00 – 7:15 PM', 'Judging Panel Deliberates — Entertainment & Music'],
